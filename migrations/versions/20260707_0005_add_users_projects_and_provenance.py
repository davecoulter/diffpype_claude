...
def downgrade() -> None:
    op.drop_constraint(
        "fk_job_configurations_user_id", "job_configurations", type_="foreignkey"
    )
    op.drop_column("job_configurations", "user_id")
    op.drop_constraint(
        "fk_step_definitions_user_id", "step_definitions", type_="foreignkey"
    )
